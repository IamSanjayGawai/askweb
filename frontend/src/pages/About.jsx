    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          ...
          <p>The platform offers suggestions based on the specific issues users want to resolve. Whether you’re looking for career guidance, financial planning, or psychological support, AskExp helps you choose the right expert by presenting relevant profiles with detailed qualifications</p>
